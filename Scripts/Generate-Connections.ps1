...
Function Get-ConnectionsFile {
  ...
  $connectionsJson = Get-Content $outputLocation | ConvertFrom-Json
  $serviceProviderConnections = $connectionsJson.serviceProviderConnections

  $json = $withFunctions ? @{ "managedApiConnections" = $apiConnections; "serviceProviderConnections" = $serviceProviderConnections; "functionConnections" = $functionConnections } : @{ "managedApiConnections" = $apiConnections; "serviceProviderConnections" = $serviceProviderConnections; }
